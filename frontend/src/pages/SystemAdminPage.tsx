...
const LINKS: AdminLink[] = [
  ...
  {
    key: 'entities',
    label: 'ישויות מורכבות',
    icon: 'building',
    description: 'ישויות שתחתן אפשר לתלות מיקומים (מבנה מגורים, דירה, חניון, שטח ציבורי וכו\')',
  },
  {
    key: 'system_locations',
    label: 'מיקומי מערכת',
    icon: 'layout',
    description: 'רשימה ראשית של מיקומים (סלון, מטבח, לובי…) — משמשת את כל התבניות. תומך ייצוא/יבוא Excel',
  },
  {
    key: 'professionals',
    label: 'בעלי מקצוע',
  ...
  },
  {
    ...
    label: 'תבניות מערכת',
    icon: 'copy',
    description: 'תבניות מערכת משותפות לכל החברות במערכת. תבניות חברה נמצאות תחת "ניהול"',
  },
]
